...
class TrainerProgramClientsScreen extends StatefulWidget {
  final int trainerUserId;

  const TrainerProgramClientsScreen({
    super.key,
    required this.trainerUserId,
  });

  @override
  State<TrainerProgramClientsScreen> createState() =>
      _TrainerProgramClientsScreenState();
}

class _TrainerProgramClientsScreenState
    extends State<TrainerProgramClientsScreen> {
            ...
            children: [
              ...
              Expanded(
                child: isLoading
                    ...
                    ? const Center(
                  child: Text(
                    "Program oluşturulacak danışan bulunamadı",
                    style: AppTextStyles.subtitle,
                  ),
                )
                    : RefreshIndicator(
